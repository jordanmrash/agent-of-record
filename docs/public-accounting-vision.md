...
Professions that sign their work are adopting generative AI quickly. Most early adoption begins with individual productivity: drafting, summarizing, research assistance, spreadsheet help, or a prototype that answers questions from a document library.

Those uses are valuable, but they do not establish an operating model for repeated work a person signs their name to.
