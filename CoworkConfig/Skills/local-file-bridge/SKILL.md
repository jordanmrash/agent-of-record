...
20 rule(s) of 22 entries routed to this skill, generated from
...
working in this area: `cowork-draft07-well-formed-untested`, `onedrive-folder-mtime-not-child-mtime`.
...
The three local-machine bridges are scoped to `COPILOT_COWORK`, so the filesystem bridge is the shared
